function demanderQuestion()
{
	...
	var req = $.ajax({
		url : "http://localhost:8282/interface2037/expert/question/"+nomExpert,
		dataType : "text",
		type : "GET"
	});
...
function EnvoyerReponse()
{
	...
	var req = $.ajax({
		url : "http://localhost:8282/interface2037/expert/question",
		type : "PUT",
		data : data,
		crossOrigin : false,
		timeout : 10000
...
function signifierReponseImpossible()
{
	...
	data["idExpert"]=nameOfExpert;
	var req = $.ajax({
		url : "http://localhost:8282/interface2037/expert/question/impossible",
		dataType : "text",
		type : "PUT",
		data:data,
		crossOrigin : false,
